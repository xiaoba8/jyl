package com.example.jyl.config;
...
public class MysqlGenerator {
    ...
    private static String authorName="jyl";     //作者
    private static String table="e_user";                  //table名字
    private static String prefix="e_";                     //table前缀
